;(function(window, angular, undefined) {
  ...
  mfb.run(['$templateCache', function($templateCache) {
    $templateCache.put('ng-mfb-menu-default.tpl.html',
      ...
      '    data-mfb-toggle="{{togglingMethod}}" data-mfb-label-state="{{labelMethod}}" data-mfb-state="{{menuState}}">' +
      '  <li class="mfb-component__wrap">' +
      '    <a ng-show="closeState!=\'false\'" ng-click="clicked()" ng-mouseenter="hovered()" ng-mouseleave="hovered()"' +
      ...
      '    </a>' +
      '    <ul ng-class="{\'mfb-component--{{position}}\':closeState==\'false\', \'mfb-component__list\':closeState!=\'false\'}" ng-transclude>' +
      '    </ul>' +
      '</li>' +
      '</ul>'
    );
  ...
  mfb.directive('mfbMenu', ['$timeout', function($timeout) {
    return {
      ...
      controller: ['$scope', '$attrs', function($scope, $attrs) {
        ...
        function _isLabelMethodHover() {
        	return $scope.labelMethod === 'hover';
        }
